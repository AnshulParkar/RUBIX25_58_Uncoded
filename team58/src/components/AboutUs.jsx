      ...
      <div className="about-container">
        ...
        <div className="about-section food-wastage-section">
          ...
          <div className="carousel-container">
            ...
            >
              <div>
                <img src="/images/waste1.jpg" alt="Food Waste 1" />
              </div>
              <div>
                <img src="/images/waste2.jpg" alt="Food Waste 2" />
              </div>
              <div>
                <img src="/images/waste3.jpg" alt="Food Waste 3" />
              </div>
              <div>
                <img src="/images/waste4.jpg" alt="Food Waste 4" />
              </div>
            </Carousel>
          </div>
        </div>
